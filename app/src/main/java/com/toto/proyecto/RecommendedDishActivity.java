...
public class RecommendedDishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recommended_dish);
    ...
    private class UpdateFoodTask extends AsyncTask<Integer, Void, Boolean> {
        ...
        protected Boolean doInBackground(Integer... foods){
            ...
            SQLiteOpenHelper proyectoDatabaseHelper =
                    new ProyectoDatabaseHelper(RecommendedDishActivity.this);
            try{
        ...
        protected void onPostExecute(Boolean success){
            if(!success){
                Toast toast = Toast.makeText(RecommendedDishActivity.this,
